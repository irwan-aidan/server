...
rm acme.sh
cd .acme.sh
bash acme.sh --register-account -m irwan@aaidan.my
bash acme.sh --issue --standalone -d vpn.aidan.my --force
bash acme.sh --installcert -d vpn.aidan.my --fullchainpath /etc/xray/xray.crt --keypath /etc/xray/xray.key
